/* libpeasy-0.1.vapi generated by valac, do not modify. */
...
namespace Peasy {
	...
	public class TagQuery : GLib.Object {
		...
		public TagQuery ();
		public GLib.GenericArray<weak Geany.TMTag> exec ();
		public int match_name (string name, int len);
		public TagQuery.with_source (Peasy.TagQuery.Source source);
	}
	[CCode (cheader_filename = "peasy.h")]
	...
	[CCode (cheader_filename = "peasy.h")]
	protected static GLib.HashTable<string,int> native_abis;
	[CCode (cheader_filename = "peasy.h")]
	public static weak Geany.Plugin peasy_plugin;
	[CCode (cheader_filename = "peasy.h")]
	public static Peasy.Signals peasy_signals;
	[CCode (cheader_filename = "peasy.h")]
	public static bool check_abi (Peas.ObjectModule mod, int abi_ver);
	[CCode (cheader_filename = "peasy.h")]
